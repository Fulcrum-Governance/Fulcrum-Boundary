...
| BND-CLAIM-EDIT-001 | planned | Boundary defines a preview Edit Boundary design for routed file mutation governance. | `docs/edit-boundary/DESIGN.md`, `docs/edit-boundary/PREVIEW_CLAIMS.md` | Planned only. Edit Boundary applies only to routed edit envelopes and does not prove direct editor-write protection, filesystem sandboxing, arbitrary filesystem interception, or universal coding-agent file safety. |
