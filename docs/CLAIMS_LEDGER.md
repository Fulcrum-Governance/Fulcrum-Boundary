...
| BND-CLAIM-003 | partial | Boundary ships one production MCP adapter and six lower-maturity transport adapter packages. | Adapter package tests, A2A lifecycle tests, `docs/ADAPTER_READINESS_MATRIX.md` | Use the maturity matrix. Do not call every adapter production-grade. |
