...
boundary doctor --report                                     # Redacted local report (v0.13.0 release target)
...
The `v0.13.0` release target also includes `boundary doctor --report`, which emits
...
> `v0.8.0` and remains included in the `v0.13.0` release target; `go install …@v0.13.0` includes them.
...
> (section 11) shipped in `v0.9.0` and remain in the `v0.13.0` release target, so `go install …@v0.13.0` includes
...
> in the `v0.9.0` release and the `v0.13.0` release target; `go install …@v0.13.0` includes it.
...
> of the published `v0.12.0` release; it ships in the `v0.13.0` release target.
