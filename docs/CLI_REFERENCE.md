...
boundary doctor --report                                     # Redacted local report (published v0.13.1 release)
...
The published `v0.13.1` release includes `boundary doctor --report`, which emits
...
> the published `v0.13.1` release; the historical `@v0.8.0` install does not.
...
> `v0.8.0` and remains included in the published `v0.13.1` release; `go install …@v0.13.1` includes them.
...
> (section 11) shipped in `v0.9.0` and remain in the published `v0.13.1` release, so `go install …@v0.13.1` includes
...
> in the `v0.9.0` release and the published `v0.13.1` release; `go install …@v0.13.1` includes it.
...
> **Availability:** the `boundary hook` family ships in the published
> `v0.13.1` release.
