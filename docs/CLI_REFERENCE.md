...
boundary doctor --report                                     # Redacted local report (current v0.12.0 release)
...
current `v0.12.0` release also includes `boundary doctor --report`, which emits
...
> `v0.8.0` and remains included in the current `v0.12.0` release; `go install …@v0.12.0` includes them.
...
> (section 11) shipped in `v0.9.0` and remain in the current `v0.12.0` release, so `go install …@v0.12.0` includes
...
> in the `v0.9.0` release and the current `v0.12.0` release; `go install …@v0.12.0` includes it.
