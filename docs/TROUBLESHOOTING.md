...
The `v0.12.0` release target also includes first-run environment diagnostics and
...
The `v0.12.0` release target can use `boundary doctor --report` to emit the same
