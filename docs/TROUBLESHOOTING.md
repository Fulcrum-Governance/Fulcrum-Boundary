...
The current `v0.12.0` release also includes first-run environment diagnostics and
...
The current `v0.12.0` release can use `boundary doctor --report` to emit the same
